...
This document is giving you an overview of the DataLbry's JetBrains Space Connector for version `0.0.1`.
...
To obtain the Client ID and Client Secret you need to have an existing JetBrains Space instance. Then you can head over to [JetBrains' official documentation on how to obtain the credentials](https://www.jetbrains.com/help/space/client-credentials.html#basics).
